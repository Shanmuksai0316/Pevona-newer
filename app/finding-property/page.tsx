...
export default async function FindingPropertyPage() {
  ...
  return (
    <div className="bg-[#FAFAFA] min-h-screen">
      ...
      <section className="max-w-[1300px] mx-auto px-4 sm:px-[60px] md:px-[60px] lg:px-[60px] 1300:px-[60px] 1400:px-[80px] 1500:px-[100px] 1600:px-[130px] mt-[150px] flex flex-col lg:flex-row items-center gap-[221px]">
